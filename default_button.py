...
menu_detail2.add(KeyboardButton("Futbolka"), KeyboardButton("Bryuki "))
menu_detail2.add(KeyboardButton("Triko "), KeyboardButton("Kuylak"))
...
menu_detail3.add(KeyboardButton("Shina"), KeyboardButton("Bar "))
menu_detail3.add(KeyboardButton("Chexol "), KeyboardButton("Diska "))
